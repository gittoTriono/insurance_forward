...
final List<Color> textColorLight = [const Color(0XFF1C1C1C), const Color(0XFF434343), const Color(0XFF636363), const Color(0XFF7F7F7F)];
final List<Color> textColorDark = [const Color(0XFFFAFAFA), const Color(0XFFDFDFDF), const Color(0XFFD3D3D3), const Color(0XFFBFBFBF)];
...
final ThemeData lightThemeData = themeData(lightColorScheme, _lightFocusColor, textColorLight, textColorDark);
final ThemeData darkThemeData = themeData(darkColorScheme, _darkFocusColor, textColorDark, textColorLight);

ThemeData themeData(ColorScheme colorScheme, Color focusColor, List<Color> textColor, List<Color> borderColors) {
  return ThemeData(
      useMaterial3: true,
