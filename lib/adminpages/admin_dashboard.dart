...
class AdminDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    AdminDashboardController _adminDashboardController =
        Get.put(AdminDashboardController());
    LoginController _loginController = Get.find();

    _adminDashboardController.userid.value =
        _loginController.check.value.userId;
      ...
      child: Column(
        ...
        children: [
          Wrap(
            ...
            children: [
              SizedBox(
                width: screenSize.screenSizeIndex(_width) > 3
                    ? (_width - 100) / 3
                    : _width,
                child: Card(
                  child: Column(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          TextButton(
                              onPressed: () {
                                _adminDashboardController.pageView.value =
                                    'USERS_LIST_VIEW';
                                _adminDashboardController.usersView.value = "";
                                _adminDashboardController.getUser(
                                    _loginController.check.value.userId,
                                    _loginController.check.value.token,
                                    "PARKING_USER",
                                    0,
                                    20,
                                    "userId");
